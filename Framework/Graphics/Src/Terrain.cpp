...
float TEngine::Graphics::Terrain::GetHeightScale() const
{
	return mHeightScale;
}
...
const Mesh& TEngine::Graphics::Terrain::GetMesh() const
{
	return mMesh;
}

float TEngine::Graphics::Terrain::GetWidth() const
{
	return static_cast<float>(mColumns);
}

float TEngine::Graphics::Terrain::GetLength() const
{
